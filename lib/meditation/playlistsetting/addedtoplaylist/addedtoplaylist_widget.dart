...
import 'addedtoplaylist_model.dart';
import '/custom_code/net_image.dart';
export 'addedtoplaylist_model.dart';

class AddedtoplaylistWidget extends StatefulWidget {
  const AddedtoplaylistWidget({
    super.key,
    required this.song,
  ...
  @override
  State<AddedtoplaylistWidget> createState() => _AddedtoplaylistWidgetState();
}

class _AddedtoplaylistWidgetState extends State<AddedtoplaylistWidget> {
  late AddedtoplaylistModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddedtoplaylistModel());
  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: StreamBuilder<PlaylistsRecord>(
